...
def test_tb_twice0001(benchmark):
    benchmark(_actual_t_est, 0.0001, new_points=[])
def test_tb_twice001(benchmark):
    benchmark(_actual_t_est, 0.001, new_points=[])
def test_tb_twice01(benchmark):
    benchmark(_actual_t_est, 0.01, new_points=[])
def test_tb_twice1(benchmark):
    benchmark(_actual_t_est, 0.1, new_points=[])
def test_tb_twice2(benchmark):
    benchmark(_actual_t_est, 0.2, new_points=[])

def test_tb_incremental0001(benchmark):
    benchmark(_actual_t_est, 0.0001, new_points=[31895])
def test_tb_incremental001(benchmark):
    benchmark(_actual_t_est, 0.001, new_points=[31895])
def test_tb_incremental01(benchmark):
    benchmark(_actual_t_est, 0.01, new_points=[31895])
def test_tb_incremental1(benchmark):
    benchmark(_actual_t_est, 0.1, new_points=[31895])
def test_tb_incremental2(benchmark):
    benchmark(_actual_t_est, 0.2, new_points=[31895])
